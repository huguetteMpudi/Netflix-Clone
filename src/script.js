...
var  originalMoviesDiv = document.getElementById('original__movies');
// url api 
...
const getOriginals = () => {
const  BASE_URL_OG ='https://api.themoviedb.org/3/discover/tv?api_key=19f84e11932abbc79e6d83f82d6d1045&with_networks=213'
fetchMovies(BASE_URL_OG,'.original__movies','poster_path')


}
// ** Function that fetches Trending Movies **
function getTrendingNow() {
  const BASE_URL_TR = 'https://api.themoviedb.org/3/trending/movie/week?api_key=19f84e11932abbc79e6d83f82d6d1045'
fetchMovies(BASE_URL_TR, '#trending', 'backdrop_path')
}
// ** Function that fetches Top Rated Movies **
function getTopRated() {

const BASE_URL_R =  'https://api.themoviedb.org/3/movie/top_rated?api_key=19f84e11932abbc79e6d83f82d6d1045&language=en-US&page=1'
fetchMovies(BASE_URL_R, '#top_rated', 'backdrop_path')
}
